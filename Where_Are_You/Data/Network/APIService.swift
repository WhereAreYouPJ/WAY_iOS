...
protocol APIServiceProtocol {
    ...
    func checkUserIDAvailability(userID: String, completion: @escaping (Result<SignUpResponseModel, Error>) -> Void)
...
class APIService: APIServiceProtocol {
    ...
    func checkUserIDAvailability(userID: String, completion: @escaping (Result<SignUpResponseModel, any Error>) -> Void) {
