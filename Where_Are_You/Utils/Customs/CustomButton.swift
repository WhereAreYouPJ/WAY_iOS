...
//class CustomOptionsContainerView: UIView {
//    private var buttons: [CustomOptionButtonView1] = []
//    private var actions: [() -> Void] = []
//    
//    func configureOptions(titles: [String], actions: [() -> Void]) {
//        // 기존 버튼 제거
...
//        for (index, title) in titles.enumerated() {
//            let isLast = index == titles.count - 1
//            let buttonView = CustomOptionButtonView1(title: title, showSeparator: !isLast)
//            addSubview(buttonView)
//            buttons.append(buttonView)
//            
//            buttonView.snp.makeConstraints { make in
...
//// MARK: - 추가 옵션뷰 버튼
//class CustomOptionButtonsView: UIView {
//    private var actions: [() -> Void] = []
...
//        view.backgroundColor = .popupButtonColor
...
//    
//    // MARK: - Initializer
//    init(titles: [String], images: [UIImage?], actions: [() -> Void]) {
//        super.init(frame: .zero)
//        addSubview(buttonContainerView)
//        self.actions = actions
//        setupButtons(titles: titles, images: images)
//        setupView()
...
//    
//    // MARK: - Setup Methods
//    private func setupButtons(titles: [String], images: [UIImage?]) {
//        for (index, title) in titles.enumerated() {
//            let isLast = index == titles.count - 1
//            let button = createButton(title: title, image: images[index], showSeparator: !isLast)
//            button.tag = index
...
//    }
//    
//    private func createButton(title: String, image: UIImage? = nil, showSeparator: Bool) -> UIButton {
//        let button = UIButton(type: .system)
